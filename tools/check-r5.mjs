...
for(const legacy of ["admin.js","admin-audio.js","admin-preflight.js","admin-batch-safety.js","admin-maintenance.js","admin-bootstrap.js","admin-security.js","admin-series-status.js","admin-series-banner.js","admin-series-editor-polish.js","admin-overhaul.js","admin-abuse.js","admin-backup-history.js"]){
  if(entries.html.includes(`/assets/js/${legacy}`))fail(`Garden Keeper HTML still directly loads retired R5 owner ${legacy}`);
}
...
for(const source of ["auth","library","shell","maintenance","history","trash","abuse","version","uploadSafety","uploadEvents"]){
...
else console.log("Shadow Garden R5 Garden Keeper shell, client, session, and workflow ownership contracts passed.");
