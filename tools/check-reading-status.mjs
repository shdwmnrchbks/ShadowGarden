...
for(const marker of ["data-reading-status=\"finished\"","data-reading-status=\"unfinished\"","params.set(\"reading\"","readingStatus.libraryBannerEntry","preserveCount:true","pageshow"])if(!library.includes(marker))fail(`Library controller is missing ${marker}`);
