...
for(const marker of ['preferences.libraryView','preferences.pinnedIds','latestActiveEntry'])if(!library.includes(marker))fail(`Library must consume canonical R2 persistence/state owner ${marker}`);
