...
test("Pages wheel input is owned by desktop layout, not pointer media classification", async () => {
  ...
  assert.match(input, /doc\.addEventListener\("wheel",handleWheel,\{capture:true,passive:false\}\)/);
