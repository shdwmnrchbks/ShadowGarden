# Shadow Garden Roadmap Archive — v2.6 through v2.10

> **Status:** 🗄️ Archived 2026-09-04  
> **Superseded by:** [`../roadmaps/CURRENT_ROADMAP.md`](../roadmaps/CURRENT_ROADMAP.md)

This file preserves the completed roadmap that owned Shadow Garden from the v2.6 reliability milestone through the formal v2.10 Maintenance & Supply Chain release. It is historical planning only and does not define current work.
