...
for(const marker of ["R4 + R4.1 Reader architecture and stabilization","page-navigation-input.js","image-focus.js","Continuous mode ignores this controller completely","reader-image-focus-zoomed","focus is moved to the dialog"]){if(!readerDoc.includes(marker))fail(`Reader architecture document is missing R4.1 marker ${marker}`)}
