...
for(const marker of ["/assets/css/admin-components.css","/assets/css/admin-version.css","/assets/css/admin-presentation.css"]){if(!entries.app.includes(marker))fail(`Garden Keeper app is missing semantic R7 style ${marker}`)}
