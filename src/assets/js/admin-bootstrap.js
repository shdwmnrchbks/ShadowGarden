/* Shadow Garden v1.15.13 — Garden Keeper security + current workflow bootstrap. */
(()=>{
...
window.addEventListener('DOMContentLoaded',()=>{
  ...
  const boot=async()=>{
    await loadScript('script[data-site-flavor]','/assets/js/site-flavor.js?v=1.15.13','siteFlavor');
